...
class Root:
    ...
    def run(self):
        ...
        import os
        if hasattr(self, 'log'):
            self.log("Root.run() called directly. Subclasses should override this method.", level="DEBUG")
        elif os.environ.get("DEBUG"):
            print("Root.run() called directly. Subclasses should override this method.")
