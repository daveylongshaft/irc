...
- import migration examples from legacy `csc_loop.shared` / `server` paths
...
LAYER_PACKAGE_ORDER: tuple[LayerPackageSpec, ...] = (
    LayerPackageSpec(
        ...
        dependencies=(),
        legacy_imports=("from csc_root import Root",),
    ...
    LayerPackageSpec(
        ...
        legacy_imports=("from csc_log import Log",),
    ...
    LayerPackageSpec(
        ...
        legacy_imports=("from csc_data import Data",),
        replacement_import="from csc_data import Data",
        notes="Uses enc-ext-vfs for encrypted relative data/log storage under CSC_ROOT/vfs while keeping ServerData/ops/etc helpers in csc_loop.",
    ),
    LayerPackageSpec(
        ...
        legacy_imports=("from csc_version import Version",),
    ...
    LayerPackageSpec(
        ...
        legacy_imports=("from csc_platform import Platform",),
    ...
    LayerPackageSpec(
        ...
        legacy_imports=("from csc_network import Network",),
    ...
    LayerPackageSpec(
        ...
        replacement_import="from csc_services.service import Service",
