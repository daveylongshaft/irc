...
from csc_loop.utils import QueueDirectories, WIPJournal
from csc_platform import Platform
from csc_services import PROJECT_ROOT as _PROJECT_ROOT
...
def _get_file_ops():
    ...
    try:
        from csc_ftpd.csc_ftpd.ftp_file_ops import FtpFileOps
...
class Agent( Service ):
    ...
    def _check_prompt_capabilities(self, filepath):
        ...
        if min_ram:
            from csc_platform import _parse_size
