...
from csc_loop.utils import QueueDirectories
from csc_platform import Platform
from csc_services.agent import Agent as AgentService
...
class workorders( Service ):
    ...
    def assign(self, *args) -> str:
        ...
        if supports_direct_api:
            try:
                from csc_loop.infra.pm_executor import PMExecutor
                from pathlib import Path
                import json
        ...
        try:
            ...
            import importlib
            agent_module = importlib.import_module("csc_services.services.agent_service")
