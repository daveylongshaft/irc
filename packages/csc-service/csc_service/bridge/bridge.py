...
class Bridge:
    ...
    def _forward_to_server(self, session: ClientSession, data: bytes):
        ...
        Children:
            ...
            - encrypt(): Encrypts data with AES (csc_service.shared.crypto)
    ...
    def _server_listener(self, session: ClientSession):
        ...
        Children:
            ...
            - is_encrypted(): Checks if data is encrypted (csc_service.shared.crypto)
            - decrypt(): Decrypts data with AES key (csc_service.shared.crypto)
